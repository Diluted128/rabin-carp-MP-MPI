...
int main(int argc, char* argv[]){    
    ...
    if(rank == ROOT_RANK){
        ...
        print_block_sizes(sending_block_sizes, num_procs);
        print_block_start_index(sending_block_indexes, num_procs);
    }
    ...
    print_found_pattern_indexes(found_indexes, found_indexes_count, rank);
